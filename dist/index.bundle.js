...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ MovieStore)\n/* harmony export */ });\n/* harmony import */ var _display_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./display.js */ \"./src/modules/display.js\");\n/* harmony import */ var _movie_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./movie.js */ \"./src/modules/movie.js\");\n\n\n\nclass MovieStore {\n  Movies = [];\n\n  constructor() {\n    let i = 1;\n    while (i <= 10) {\n      this.getMovieFromAPI(i);\n      i += 1;\n    }\n  }\n\n  getMovieFromAPI(id) {\n    (0,_display_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(id)\n      .then((m) => {\n        const { name } = m;\n        const imgM = m.image.medium;\n        const imgL = m.image.original;\n        const { language } = m;\n        const { genres } = m;\n        const { runtime } = m;\n        const rating = m.rating.average;\n        const { summary } = m;\n        const movie = new _movie_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"](id, name, imgM, imgL, language, genres, runtime, rating, summary);\n        this.Movies.push(movie);\n      });\n  }\n\n  getAll() {\n    return this.Movies;\n  }\n\n  getMovie(id) {\n    return this.Movies[id - 1];\n  }\n}\n\n//# sourceURL=webpack://leaderboard/./src/modules/MovieStore.js?");
